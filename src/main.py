...
def run_train(model_name, tuning_max_evals=None):
    ...
    with mlflow.start_run():
        ...
        # mlflow log metric
        mlflow.log_metric("val_loss", mean_val_score)
        ...
        # mlflow log model
        if 
            mlflow.lightgbm.log_model(, artifact_path="apt_model_lgbm")
        else:
            mlflow.catboost.log_model(, artifact_path="apt_model_catboost")
